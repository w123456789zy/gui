...
def call_openai_api(messages, client:OpenAI, model="GLM-4.1V-Thinking-FlashX"):
...
def main():
    ...
    parser.add_argument(
        "--api-key", default="dfaa499ead6a4e79b6e5af304b2c16cc.Vu7rXUc7riSvLuHn", help="API key (use 'dummy' for local vLLM)"
    )
    parser.add_argument("--model", default="glm-4.1v-thinking-flashx", help="Model name")
